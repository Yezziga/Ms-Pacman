...
import dataRecording.DataCollectorAIController;
import dataRecording.DataCollectorController;
import dataRecording.DataSaverLoader;
import dataRecording.DataSplitter;
...
public class Executor {
	...
	public static void main(String[] args) {
		...
		// ##################### OUR PACMAN ##################
			...
			// run to collect data for AI
//		 MyPacMan pacman = new MyPacMan();
//		 exec.runGameTimed(new DataCollectorAIController(pacman), new StarterGhosts(), visual);
...
//		// prints some information about the accuracy
		...
		/*
		 * //run a game in synchronous mode: game waits until controllers respond. int
		 * delay=5; boolean visual=true; exec.runGame(new RandomPacMan(),new
		 ...
		 * are ready - this is the mode of the competition. //time limit of DELAY ms
		 * still applies. boolean visual=true; boolean fixedTime=false;
		 ...
		 * stage. boolean visual=true; String fileName="replay.txt";
		...
		// exec.runGameTimed(new DataCollectorController(new KeyBoardInput()),new
		// StarterGhosts(),visual);
	}
	 ...
	 * in the competition. Can be played with and without visual display of game
	 * states.
	 *
	 * @param pacManController
	 *            The Pac-Man controller
	 ...
	 * replied. The time limit still applies so so the game will proceed after 40ms
	 * regardless of whether the controllers managed to calculate a turn.
	 * 
	 * @param pacManController
	 *            The Pac-Man controller
	 * @param ghostController
	 *            The Ghosts controller
	 * @param fixedTime
	 *            Whether or not to wait until 40ms are up even if both controllers
	 *            already responded
	 * @param visual
	 *            Indicates whether or not to use visuals
	 */
